...
const Intro = () => {
  return (
    <section className="w-full mb-18 md:mb-22 lg:mb-28">
      ...
      w-screen md:-translate-x-1/4 -translate-y-10 md:translate-y-0">
        <FlowerLogo
          fillColor='#EFEFEF'
          width='500'
        />
      </div>
      <div className="mb-12 mx-12 pt-16 flex flex-col items-start">
        <div className="w-fit">
          ...
          <h1 className="text-7xl font-cosmicaBold tracking-tighter leading-tight md:pr-8">
            <span className="flex inline-flex gap-x-5 mr-6">
              SYD
