...
'Umi Feeds, WREK, TAing, and now work'

'create an Umi Feeds section'

'add new game!'

'Now that I have graduated, I hope to leave a great impact during my career.' //TODO: improve

const About = () => {
  return <div className="mx-12 text-lg">{about_text}</div>
}
